 ...
 * la mitad inferior del Hero. Entre la onda y el bloque de texto hay un
 * velo (scrim) radial de surface-base que se desvanece hacia los bordes:
...
export function Hero() {
  return (
    <section className="relative flex min-h-[820px] items-center overflow-hidden bg-surface-base pb-16 pt-[168px] md:min-h-[840px] md:pb-20 md:pt-[184px]">
      ...
      <div className="relative mx-auto w-full max-w-page px-5 text-center sm:px-6 md:px-10 lg:px-12 xl:px-14">
        <h1 className="mx-auto max-w-[1000px] text-[clamp(3rem,1.2rem+6vw,6rem)] font-extrabold leading-[0.98] tracking-[-0.02em] text-fg-primary">
          Un Mar de Ideas
        </h1>

        <p className="mt-7 font-display text-sm font-semibold uppercase tracking-[0.14em] text-fg-muted sm:text-base">
          DOFI Agencia Creativa
        </p>

        <p className="mx-auto mt-7 max-w-[700px] text-balance font-sans text-xl leading-relaxed text-fg-primary/90 md:text-2xl">
          Convertimos atención en Ventas Inteligentes
        </p>

        <div className="mx-auto mt-9 flex w-full max-w-[420px] flex-col gap-4 sm:max-w-none sm:flex-row sm:items-center sm:justify-center">
          <Link
            href="/contactanos"
